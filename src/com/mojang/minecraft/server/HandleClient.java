	...
	private void c(String var1) {
		...
		if(this.q > 600) {
			...
			if(var1.startsWith("/")) {
                ...
                ChatEvent ev = new ChatEvent(this.player,var1);
                this.k.HoseCraft.getPluginManager().callEvent(ev);
                if (!ev.isCancelled()) {
                    j.info(this.b + " says: " + ev.getMessage());
                    this.k.a(PacketType.CHAT_MESSAGE, new Object[]{Integer.valueOf(this.c), this.b + ": " + ev.getMessage()});
                }
			}
		}
	}
	...
	public final void a() {
			...
			for(boolean var1 = true; this.p.size() > 0 && var1; var1 = var10000) {
				...
				if((var2 = (Object[])this.p.remove(0))[0] instanceof Short) {
					...
					if(this.s == 100) {
						...
						Level var7 = this.player.getLocation().getLevel();

                        int X = (int) (this.player.getLocation().getX()*32);
                        int Y = (int) (this.player.getLocation().getY()*32)+51+22;
                        int Z = (int) (this.player.getLocation().getZ()*32);

						float var8 = (float)var13 -  X / 32.0F;
						float var9 = (float)var3 - (Y / 32.0F - 1.62F);
						float var10 = (float)var4 - Z / 32.0F;
							...
							if(var5 == 0) {
								if(var7.getTile(var13, var3, var4) != Block.BEDROCK.id || this.k.g.c(this.b)) {
									...
									if (!ev.isCancelled()) {
                                        ...
                                        // Cancelled - Resend current block to the player.
										this.k.a(var13, var3, var4);
									}
								}
							} else {
								Block var18;
								if((var18 = Block.blocks[var7.getTile(var13, var3, var4)]) == null || var18 == Block.WATER || var18 == Block.STATIONARY_WATER || var18 == Block.LAVA || var18 == Block.STATIONARY_LAVA) {
                                    ...
                                    if (!ev.isCancelled()) {
                                        ...
                                        // Cancelled - Resend currentblock to player.
                                        this.k.a(var13, var3, var4);
                                    }
								}
							}
					...
					if(var13 == this.d && var3 == this.e && var4 == this.f && var5 == this.h && var6 == this.g) {
						...
						if(this.t++ % 2 == 0) {
							...
							int var24 = var4 - (int) this.player.getLocation().getZ();

							if(var22 >= 128 || var22 < -128 || var23 >= 128 || var23 < -128 || var24 >= 128 || var24 < -128 || this.t % 20 <= 1) {

                                Location from = this.player.getLocation();
                                Location to = new Location(this.player.getLocation().getLevel(), var13, var3-51, var4, var5, var6);
                                PlayerMoveEvent mv = new PlayerMoveEvent(this.player,from,to);
                                this.k.HoseCraft.getPluginManager().callEvent(mv);
                                if (!mv.isCancelled()) {
                                    /*
                                    this.d = var13;
                                    this.e = var3;
                                    ...
                                    this.g = var6;
                                    */
                                    this.player.getLocation().setX(var13);
                                    this.player.getLocation().setY(var3 - 51);
                                    this.player.getLocation().setZ(var4);
							...
							if(var13 == this.d && var3 == this.e && var4 == this.f) {
                                ...
                                */
                                ...
                                Location from = this.player.getLocation();
                                Location to = new Location(this.player.getLocation().getLevel(), var13, var3-51, var4, from.getYaw(), from.getPitch());
                                PlayerMoveEvent mv = new PlayerMoveEvent(this.player,from,to);
                                this.k.HoseCraft.getPluginManager().callEvent(mv);
                                if (!mv.isCancelled()) {
                                    /*
		...
		if(!this.l && System.currentTimeMillis() - this.o > 5000L) {
			...
			this.NetworkManager.a(PacketType.SPAWN_PLAYER, new Object[]{Integer.valueOf(-1), this.b, Integer.valueOf(this.d), Integer.valueOf(this.e), Integer.valueOf(this.f), Integer.valueOf(this.h), Integer.valueOf(this.g)});
			 ...
			 Location spawnLoc = new Location(this.k.c,(double) this.d/32,(double) this.e/32,(double) this.f/32, Integer.valueOf((int)(var11.rotSpawn * 256.0F / 360.0F)).byteValue() , Integer.valueOf(0).byteValue());
            ...
            this.k.HoseCraft.getPluginManager().callEvent(ev);
			 this.k.a(PacketType.CHAT_MESSAGE, new Object[]{Integer.valueOf(-1), ev.getMessage()});
