...
public abstract class Entity implements Serializable {
    ...
    protected void setPos(PositionUpdate var1) {
    ...
    public void move(float var1, float var2, float var3) {
        if (this.noPhysics) {
            ...
            this.x = (this.bb.maxX + this.bb.minX) / 2.0F;
            this.y = this.bb.maxY + this.heightOffset - this.ySlideOffset;
            this.z = (this.bb.maxZ + this.bb.minZ) / 2.0F;
        } else {
            float var4 = this.x;
            float var5 = this.z;
            float var6 = var1;
            ...
            if (this.makeStepSound) {
                ...
                if (this.walkDist > (float) this.nextStep && var19 > 0) {
                    ...
                    if ((var20 = Block.blocks[var19].ac) != Tile$SoundType.none) {
